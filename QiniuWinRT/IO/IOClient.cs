...
namespace Qiniu.IO
{
    ...
    public class IOClient
    {
        ...
        public async Task<PutRet> PutFile(string upToken, string key, string localFile, PutExtra extra)
        {
            ...
            {
                ret = new PutRet(new CallRet(Windows.Web.Http.HttpStatusCode.BadRequest, e));
                onPutFinished(ret);
                return ret;
            }
        }
        ...
        /// <param name="extra">Extra.</param>
        public async Task<PutRet> Put(string upToken, string key, System.IO.Stream putStream, PutExtra extra)
        {
