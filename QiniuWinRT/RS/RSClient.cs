...
namespace Qiniu.RS
{
	...
	public class RSClient : QiniuAuthClient
	{
        ...
        {
            return await CallWithBinary(Conf.Config.RS_HOST + "/batch",new Windows.Web.Http.Headers.HttpMediaTypeHeaderValue("application/x-www-form-urlencoded"), StreamEx.ToStream(requestBody), requestBody.Length);
        }	
